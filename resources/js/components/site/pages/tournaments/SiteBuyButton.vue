<template>
    ...
    <a :href="tournament.stripe_key" target="_blank" class="btn btn-lg btn-success" title="Vous pouvez quand même payer votre entrée sur place avant la Lan" v-if="tournament.stripe_key">
